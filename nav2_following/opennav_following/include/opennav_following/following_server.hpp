...
protected:
  ...
  geometry_msgs::msg::Twist computeRotateToHeadingCommand(
    const double & angular_distance, const geometry_msgs::msg::Twist & current_velocity, const double & dt);
  ...
  typename std::shared_ptr<FollowingActionServer> following_action_server_;
